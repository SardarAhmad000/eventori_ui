...
class _HomeVendorScreenState extends State<HomeVendorScreen> {
  ...
  void initState() {
    ...
    print(authController.storedFirstNameForReuse.value);
    authController.getUserData();
    print("${authController.userData.value?.firstName ?? ' '} name of vendor on Home Vendor Screen is : ");
                                ...
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CustomImageHandler(
                                      imagePath:authController.userData.value!=null? authController.userData.value!.image:'',
                                      width: 40,
                                      height: 40,
                                      fit: BoxFit.cover,
                                    ),
                        ...
                        Row(
                          children: [
                            GestureDetector(
                              onTap: (){
                                print(
                                    "${authController.userData.value!.firstName ?? ''} :name of vendor onBell Icon is :"
                                );
                              },
