...
class VendorBookingBottomSheet extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final vendorBookingController = Get.find<VendorBookingController>();
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      vendorBookingController.resetBookingForm();
                      Navigator.pop(context);
                      },
                    child: Container(
                      width: 24,
                  ...
                  children: [
                    ...
                    Obx(() => Column(
                      ...
                      children: [
                        CustomTextField(
                          ...
                          fieldBorderColor: vendorBookingController.nameError.value != null
                              ? AppTheme.redColor
                              : AppTheme.textfieldBorderColor,
                          onChanged: (value) {
                            if (value.isNotEmpty) {
                              vendorBookingController.nameError.value = null;
                            }
                            },
                        ),
                        if (vendorBookingController.nameError.value != null)
                          Padding(
                            padding: const EdgeInsets.only(left: 12, top: 4),
                            child: Text(
                              vendorBookingController.nameError.value!,
                              style: AppTextStyle.f12W400RColorTextStyle,
                            ),
                          ),
                      ],
                    ...
                    Obx(() => Column(
                      ...
                      children: [
                        CustomTextField(
                          ...
                          fieldBorderColor: vendorBookingController.emailError.value != null
                              ? AppTheme.redColor
                              : AppTheme.textfieldBorderColor,
                          onChanged: (value) {
                            if (value.isNotEmpty) {
                              vendorBookingController.emailError.value = null;
                            }
                            },
                        ),
                        if (vendorBookingController.emailError.value != null)
                          Padding(
                            padding: const EdgeInsets.only(left: 12, top: 4),
                            child: Text(
                              vendorBookingController.emailError.value!,
                              style: AppTextStyle.f12W400RColorTextStyle,
                            ),
                          ),
                      ],
                    ...
                    Obx(() => Column(
                      ...
                      children: [
                        CustomTextField(
                          ...
                          fieldBorderColor: vendorBookingController.phoneError.value != null
                              ? AppTheme.redColor
                              : AppTheme.textfieldBorderColor,
                          onChanged: (value) {
                            if (value.isNotEmpty) {
                              vendorBookingController.phoneError.value = null;
                            }
                            },
                        ),
                        if (vendorBookingController.phoneError.value != null)
                          Padding(
                            padding: const EdgeInsets.only(left: 12, top: 4),
                            child: Text(
                              vendorBookingController.phoneError.value!,
                              style: AppTextStyle.f12W400RColorTextStyle,
                            ),
                          ),
                      ],
                    ...
                    CustomButton(
                      ...
                      onTap: () {
                        ...
                        // Validate text fields using CustomValidator
                        bool isValid = CustomValidator.validateBookingFields(
                          name: vendorBookingController.nameBookedController.text,
                          email: vendorBookingController.emailBookedController.text,
                          phone: vendorBookingController.phoneBookedController.text,
                          onNameError: (error) => vendorBookingController.nameError.value = error,
                          onEmailError: (error) => vendorBookingController.emailError.value = error,
                          onPhoneError: (error) => vendorBookingController.phoneError.value = error,
                        );
                        ...
                        bool isSameAsCurrentDate = selectedDate.year == now.year &&
                            selectedDate.month == now.month &&
                            selectedDate.day == now.day;
