...
//                     backgroundColor: AppTheme.paperWhiteColor,
//                     primaryColor: AppTheme.PeachColor,
...
//                                   height: 50,
//                                   decoration: BoxDecoration(
//                                     color: isOwnMessage ? AppTheme.PeachColor : Colors.grey,
...
class ChatDetailedScreen extends StatelessWidget {
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        isOwnMessage ? 'You' : authorName,
                                        style: AppTextStyle.font12W500WColorTextStyle.copyWith(color: isOwnMessage ? AppTheme.purpleColor :AppTheme.slateGreyColor,)
                                      ),
                                      const SizedBox(height: 4),
                                      Text(
                                        messageText,
  ...
  Widget _buildReplyPreview(types.Message repliedMessage, ChatDetailedController controller) {
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            textMessage.text,
            style: isOwnMessage
                ? AppTextStyle.font12W500WColorTextStyle
                : AppTextStyle.font12W400BColorTextStyle,
          ),
        ],
      ),
    );
