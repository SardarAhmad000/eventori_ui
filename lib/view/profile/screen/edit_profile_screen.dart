...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    super.initState();
    profileController.selectedImage.value = authController.userData.value!.image??'';
    profileController.editEmailController.text = authController.userData.value!.email;
    profileController.editPhoneController.text = authController.userData.value!.phoneNumber;
    profileController.selectedGender.value = authController.userData.value!.gender;
    profileController.selectedCity.value = authController.userData.value!.city;
    profileController.selectedCountry.value = authController.userData.value!.country;
    ...
    print( authController.userData.value!.gender);
    print( authController.userData.value!.country);
    print( authController.userData.value!.city);
  }

  // Method to show image source options using CustomImagePicker
                  ...
                  onTap: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      if (selectedProfileImage != null) {
                        print('Profile Image Path: ${selectedProfileImage!.path}');
                        print('Profile Image Selected: Yes');
                      } else {
                        print('Profile Image Selected: No');
                      }
                      profileController.updateProfile(
                          // profileController.editLocationController.text,
